              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-600 mt-1">Вся городская территория Челябинска за 60-90 минут: Центральный, Калининский, Курчатовский (Северо-Запад), Ленинский, Металлургический (ЧМЗ), Советский (АМЗ), Тракторозаводский (ЧТЗ), а также отдалённые районы.</p>
                  </div>
                </div>
